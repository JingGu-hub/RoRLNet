...
UCR128_DATASET = ['ElectricDevices']

                                #'ArticularyWordRecognition', 'CharacterTrajectories', 'FaceDetection', 'FingerMovements',
                                #'JapaneseVowels', 'PenDigits', 'SpokenArabicDigits', 'LSST', 'InsectWingbeat'
Multivariate2018_arff_DATASET = ['ArticularyWordRecognition']

# Multivariate2018_UEA30 = ['ArticularyWordRecognition', 'AtrialFibrillation', 'BasicMotions', 'CharacterTrajectories',
#                           'Cricket', 'DuckDuckGeese', 'EigenWorms', 'Epilepsy', 'ERing', 'EthanolConcentration',
...
Four_dataset = ['HAR']
# Four_dataset = ['ArabicDigits', 'AUSLAN', 'NetFlow', 'ISRUC', 'UniMiB-SHAR', 'HAR', 'Sleep-EDF', 'Epilepsy', 'FD', 'UWare', 'Wafer']
